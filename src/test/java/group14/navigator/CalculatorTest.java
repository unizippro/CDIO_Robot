...
public class CalculatorTest {
    ...
    public void getAngleBetweenPoint() {
        var point1 = new Point2D.Double(1, 1);
        var point2 = new Point2D.Double(2, 2);
        ...
        assertEquals(90, Calculator.getAngleBetweenPoint(point1, new Point2D.Double(1, 3)), 0);
        assertEquals(0, Calculator.getAngleBetweenPoint(point1, new Point2D.Double(2, 1)), 0);
    }

    @Test
    public void getVectorEndPoint() {
        var endPoint = Calculator.getVectorEndPoint(new Point2D.Double(1, 1), 0, 5);
        assertEquals(6, endPoint.x, 0);
        assertEquals(1, endPoint.y, 0);

        var endPoint2 = Calculator.getVectorEndPoint(new Point2D.Double(1, 1), 90, 5);
        assertEquals(1, endPoint2.x, 0.001);
        assertEquals(6, endPoint2.y, 0.001);

        var endPoint3 = Calculator.getVectorEndPoint(new Point2D.Double(1, 1), 45, 5);
