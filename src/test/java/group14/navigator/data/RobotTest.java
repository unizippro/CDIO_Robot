...
public class RobotTest {
    ...
    public void setUp() throws Exception {
        this.robot = new TestRobot(new Point2D(0, 0), new Point2D(1, 1));
    }

    @Test
    public void getFrontPosition() {
        var robot = new TestRobot(new Point2D(50, 8), new Point2D(50, 10));
    ...
    public void getDirectionAngle() {
        ...
        var robot = new TestRobot(new Point2D(1, 1), new Point2D(1, 2));
        assertEquals(270, robot.getDirectionAngle(), 0);

        var robot2 = new TestRobot(new Point2D(1, 1), new Point2D(0, 1));
    ...
    public void getRotatingPoint() {
        ...
        var robot1 = new TestRobot(new Point2D(2, 0), new Point2D(0, 0));
    ...
    public void getDistanceTo() {
        var robot = new TestRobot(new Point2D(50, 18), new Point2D(50, 20));
        assertEquals(10, robot.getDistanceTo(new Point2D(50, 0)), 0);
    }
